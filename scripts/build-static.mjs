...
const excluded=new Set(['supabase-config.js','supabase-store.js','maps-config.js','voice.js','navigation.js']);
...
console.log('Built local-family frontend in dist. Live uses the separate server endpoint; no API keys included.');
